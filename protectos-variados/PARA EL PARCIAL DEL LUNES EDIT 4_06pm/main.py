...
class LSL:
    ...
    def recorrer(self):
        ...
        if p == None:
            ...
            while p != None:
                print(f"Nodo con dato {p.retorna_dato()} apunta a nodo con dato {p.retorna_liga().retorna_dato()}") if p.retorna_liga() else (f"Nodo final con dato {p.retorna_dato()}")
                print("----------------------")
                print(p.retorna_dato(), "-->", p.retorna_liga())
                #print(p.retorna_dato())
                p = p.retorna_liga()
                
    def mostrrarDatos(self):
